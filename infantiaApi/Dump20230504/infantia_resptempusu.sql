...
CREATE TABLE `resptempusu` (
  ...
  KEY `fk_Respuesta_has_Temporalidad_Respuesta1_idx` (`idRespuesta`,`idPregunta`,`cedulaCuidador`),
  ...
  CONSTRAINT `fk_Respuesta_has_Temporalidad_Respuesta1` FOREIGN KEY (`idRespuesta`, `idPregunta`, `cedulaCuidador`) REFERENCES `respuesta` (`idRespuesta`, `idPregunta`, `cedulaCuidador`),
