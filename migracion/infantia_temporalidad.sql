...
--
-- Table structure for table `temporalidad`
--
...
--
-- Dumping data for table `temporalidad`
--

LOCK TABLES `temporalidad` WRITE;
/*!40000 ALTER TABLE `temporalidad` DISABLE KEYS */;
/*!40000 ALTER TABLE `temporalidad` ENABLE KEYS */;
UNLOCK TABLES;
